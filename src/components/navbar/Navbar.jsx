...
import { NAVBAR__LEFT__LIST } from "../../static/index";
import { NAVBAR__RIGHT__LIST } from "../../static/index";
...
const Navbar = () => {
    const navLeftList = NAVBAR__LEFT__LIST.map((item) => {
        return (
            <li key={item} className="header__left__item">
                <a href="#">{item}</a>
            </li>
        );
    });
    const navRightList = NAVBAR__RIGHT__LIST.map((item) => {
        return (
            <li key={item} className="header__right__item">
                <a href="#">{item}</a>
            </li>
        );
    });
        ...
        <header id="header">
            <div className="header container">
                <div className="header__left">
                    ...
                    <ul className="header__left__list">{navLeftList}</ul>
                </div>
                <div className="header__right">
                    <ul className="header__right__list">{navRightList}</ul>
